...
echo "# For data set, we print file size (in bytes), successive intersections, successive unions and total unions (in cycles) [for roaring we also report the heap-based total union time in cycles]"
