...
declare -a commands=('bitset_benchmarks' 'stl_vector_benchmarks' 'stl_hashset_benchmarks' 'bitmagic_benchmarks'  'bitmagic_benchmarks -r' 'roaring_benchmarks -r' 'roaring_benchmarks_nobitsetconv -r' 'roaring_benchmarks -c -r' 'roaring_benchmarks' 'roaring_benchmarks_nobitsetconv '  'roaring_benchmarks -c'   'ewah32_benchmarks'  'ewah64_benchmarks' 'wah32_benchmarks' 'concise_benchmarks' );
